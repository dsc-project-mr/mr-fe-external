  ...
  return (
    ...
    >
      ...
      <Typography variant="body1" component="p">
        ...
        support has become even more important. With their help, we can deliver
        timely and effective assistance, and implement programmes that help
        communities not just recover, but thrive.
      </Typography>
      ...
      <Typography variant="body1" component="p">
        ...
        communities in Asia Pacific. If you are interested in collaborating with
        us, you can write to us at intouch@mercyrelief.org
      </Typography>
    </Box>
  )
}
